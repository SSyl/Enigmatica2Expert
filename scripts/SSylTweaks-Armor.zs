...
recipes.addShaped(<thermalfoundation:armor.helmet_electrum>, [[<ore:plateElectrum>, <ore:plateElectrum>, <ore:plateElectrum>], [<ore:plateElectrum>, <minecraft:leather_helmet>.anyDamage(), <ore:plateElectrum>]]);
recipes.addShaped(<thermalfoundation:armor.plate_electrum>, [[<ore:plateElectrum>, <minecraft:leather_chestplate>.anyDamage(), <ore:plateElectrum>], [<ore:plateElectrum>, <ore:plateElectrum>, <ore:plateElectrum>], [<ore:plateElectrum>, <ore:plateElectrum>, <ore:plateElectrum>]]);
recipes.addShaped(<thermalfoundation:armor.legs_electrum>, [[<ore:plateElectrum>, <ore:plateElectrum>, <ore:plateElectrum>], [<ore:plateElectrum>, <minecraft:leather_leggings>.anyDamage(), <ore:plateElectrum>], [<ore:plateElectrum>, null, <ore:plateElectrum>]]);
recipes.addShaped(<thermalfoundation:armor.boots_electrum>, [[<ore:plateElectrum>, null, <ore:plateElectrum>], [<ore:plateElectrum>, <minecraft:leather_boots>.anyDamage(), <ore:plateElectrum>]]);
...
recipes.addShaped(<minecraft:golden_helmet>, [[<ore:plateBronze>, <ore:plateBronze>, <ore:plateBronze>], [<ore:plateBronze>, <minecraft:iron_helmet>.anyDamage(), <ore:plateBronze>]]);
recipes.addShaped(<minecraft:golden_chestplate>, [[<ore:plateBronze>, <minecraft:iron_chestplate>.anyDamage(), <ore:plateBronze>], [<ore:plateBronze>, <ore:plateBronze>, <ore:plateBronze>], [<ore:plateBronze>, <ore:plateBronze>, <ore:plateBronze>]]);
recipes.addShaped(<minecraft:golden_leggings>, [[<ore:plateBronze>, <ore:plateBronze>, <ore:plateBronze>], [<ore:plateBronze>, <minecraft:iron_leggings>.anyDamage(), <ore:plateBronze>], [<ore:plateBronze>, null, <ore:plateBronze>]]);
recipes.addShaped(<minecraft:golden_boots>, [[<ore:plateBronze>, null, <ore:plateBronze>], [<ore:plateBronze>, <minecraft:iron_boots>.anyDamage(), <ore:plateBronze>]]);

recipes.addShaped(<minecraft:golden_helmet>, [[<ore:plateInvar>, <ore:plateInvar>, <ore:plateInvar>], [<ore:plateInvar>, <minecraft:iron_helmet>.anyDamage(), <ore:plateInvar>]]);
recipes.addShaped(<minecraft:golden_chestplate>, [[<ore:plateInvar>, <minecraft:iron_chestplate>.anyDamage(), <ore:plateInvar>], [<ore:plateInvar>, <ore:plateInvar>, <ore:plateInvar>], [<ore:plateInvar>, <ore:plateInvar>, <ore:plateInvar>]]);
recipes.addShaped(<minecraft:golden_leggings>, [[<ore:plateInvar>, <ore:plateInvar>, <ore:plateInvar>], [<ore:plateInvar>, <minecraft:iron_leggings>.anyDamage(), <ore:plateInvar>], [<ore:plateInvar>, null, <ore:plateInvar>]]);
recipes.addShaped(<minecraft:golden_boots>, [[<ore:plateInvar>, null, <ore:plateInvar>], [<ore:plateInvar>, <minecraft:iron_boots>.anyDamage(), <ore:plateInvar>]]);

recipes.addShaped(<minecraft:golden_helmet>, [[<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>], [<ore:plateSteel>, <minecraft:iron_helmet>.anyDamage(), <ore:plateSteel>]]);
recipes.addShaped(<minecraft:golden_chestplate>, [[<ore:plateSteel>, <minecraft:iron_chestplate>.anyDamage(), <ore:plateSteel>], [<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>], [<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>]]);
recipes.addShaped(<minecraft:golden_leggings>, [[<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>], [<ore:plateSteel>, <minecraft:iron_leggings>.anyDamage(), <ore:plateSteel>], [<ore:plateSteel>, null, <ore:plateSteel>]]);
recipes.addShaped(<minecraft:golden_boots>, [[<ore:plateSteel>, null, <ore:plateSteel>], [<ore:plateSteel>, <minecraft:iron_boots>.anyDamage(), <ore:plateSteel>]]);
